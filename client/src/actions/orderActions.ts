...
import { AppActions, CREATE_ORDER_REQUEST, CREATE_ORDER_SUCCESS, CREATE_ORDER_FAILURE, UPDATE_ORDER_REQUEST, UPDATE_ORDER_SUCCESS, UPDATE_ORDER_FAILURE, DELETE_ORDER_REQUEST, DELETE_ORDER_SUCCESS, DELETE_ORDER_FAILURE, LIST_ORDER_REQUEST, LIST_ORDER_SUCCESS, LIST_ORDER_FAILURE } from "../constants/action-types";
...
export const listOrders = () => async (dispatch: Dispatch<AppActions>,
  getState: getStateType) => {
